<template>
  <div>
    ...
    <p class="text-center my-8">
      Complete your password reset request by filling out this form:
    </p>
    <form class="w-full max-w-sm mx-auto">
      ...
      <div class="md:flex md:items-baseline mb-6">
        ...
        <div class="md:w-2/3">
          ...
          <p
            ...
            v-if="hasValidationError('password')"
          >
      ...
      <div class="md:flex md:items-baseline mb-6">
        ...
        <div class="md:w-2/3">
          ...
          <p
            class="text-red text-sm mt-1"
            v-if="hasValidationError('password_confirmation')"
          >
      ...
      <div class="md:flex md:items-baseline">
        ...
        <div class="md:w-2/3">
          <button
            ...
            type="button"
            @click.prevent="attemptPasswordChange"
          >
            Reset Password
          </button>
        </div>
